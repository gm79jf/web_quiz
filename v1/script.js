document.getElementById('startQuiz').addEventListener('click', () => {
    ...
    if (file) {
        ...
        reader.onload = function (event) {
            ...
            const perguntasRespostas = parseCSV(data);
            iniciarQuiz(perguntasRespostas);
        };
...
function iniciarQuiz(dados) {
    const { pergunta, respostaCorreta, todasRespostas } = selecionarPergunta(dados);
